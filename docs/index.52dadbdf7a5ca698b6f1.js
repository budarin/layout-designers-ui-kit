    ...
    [5],
    {
        '+fcl': function(n, o, e) {
            (n.exports = e('I1BE')(!1)).push([
                n.i,
                ":root {\n    /* COLOR VARIABLES */\n    --color_orange: var(--custom-color_01, #ff9900);\n    --color_orange_75: var(--custom-color_02, #ffcc00);\n    --color_white_25: var(--custom-color_03, #fff6d1);\n    --color_white_50: var(--custom-color_04, #ffffcc);\n    --color_purple_25: var(--custom-color_05, #9900ff);\n    --color_purple_50: var(--custom-color_06, #660099);\n    --color_purple_75: var(--custom-color_07, #4f196d);\n    --color_purple: var(--custom-color_08, #330066);\n    --color_green: var(--custom-color_09, #66cc00);\n    --color_green_75: var(--custom-color_10, #00cc00);\n    --color_white: var(--custom-color_11, #ffffff);\n    --color_black: var(--custom-color_12, #000000);\n    --color_gray: var(--custom-color_13, #666666);\n    --color_gray_75: var(--custom-color_14, #999999);\n    --color_gray_50: var(--custom-color_15, #cccccc);\n    --color_gray_25: var(--custom-color_16, #e3e3e3);\n    --color_gray_20: var(--custom-color_17, #f4f4f4);\n    --color_black_50: var(--custom-color_18, rgba(0, 0, 0, 0.5));\n    --color_black_0: var(--custom-color_19, rgba(0, 0, 0, 0.1));\n\n    /* SIZE VARIABLES */\n    --base-size: 4;\n    --x0_25: calc(0.25 * var(--base-size) * 1px);\n    --x0_5: calc(0.5 * var(--base-size) * 1px);\n    --x1: calc(var(--base-size) * 1px);\n    --x1_5: calc(1.5 * var(--base-size) * 1px);\n    --x2: calc(2 * var(--base-size) * 1px);\n    --x2_5: calc(2.5 * var(--base-size) * 1px);\n    --x3: calc(3 * var(--base-size) * 1px);\n    --x3_5: calc(3.5 * var(--base-size) * 1px);\n    --x4: calc(4 * var(--base-size) * 1px);\n    --x4_5: calc(4.5 * var(--base-size) * 1px);\n    --x5: calc(5 * var(--base-size) * 1px);\n    --x6: calc(6 * var(--base-size) * 1px);\n    --x7: calc(7 * var(--base-size) * 1px);\n    --x8: calc(8 * var(--base-size) * 1px);\n    --x9: calc(9 * var(--base-size) * 1px);\n    --x10: calc(10 * var(--base-size) * 1px);\n    --x11: calc(11 * var(--base-size) * 1px);\n    --x12: calc(12 * var(--base-size) * 1px);\n    --x13: calc(13 * var(--base-size) * 1px);\n    --x14: calc(14 * var(--base-size) * 1px);\n    --x15: calc(15 * var(--base-size) * 1px);\n    --x16: calc(16 * var(--base-size) * 1px);\n    --x17: calc(17 * var(--base-size) * 1px);\n    --x18: calc(18 * var(--base-size) * 1px);\n    --x: var(--line-height);\n\n    /* BORDER SIZE VARIABLES*/\n    --border-width: var(--x0_25);\n\n    /* SHADOW VARIABLES*/\n    --shadow-color: var(--color_black_50);\n    --shadow-small: 0 var(--x0_25) var(--x1) 0;\n    --shadow-medium: 0 var(--x0_5) var(--x2) 0;\n    --shadow-big: 0 var(--x1) var(--x4) 0;\n\n    /* MEDIA QUERIES */\n    --desktop: 1280px;\n    --desktop-small: 960px;\n    --tablet: 800px;\n    --tablet-small: 640px;\n    --mobile: 480px;\n    --mobile-small: 375px;\n\n    /* FONT VARIABLES */\n    --font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Fira Sans',\n        'Droid Sans', 'Helvetica Neue', sans-serif;\n    --line-height: calc(var(--x4) * 1.5);\n    --font-weight-regular: 400;\n    --font-weight-bold: 700;\n\n    /* BORDER RADIUS VARIABLE*/\n    --border-radius-x1: var(--x1);\n    --border-radius-50: 50%;\n    --radius: var(--x1);\n\n    /* PADDING VARIABLES */\n    --padding-x8: 0 var(--x8);\n    --padding-x6: 0 var(--x6);\n    --padding-x5: 0 var(--x5);\n    --padding-x4: 0 var(--x4);\n    --padding-x2_5: 0 var(--x2_5);\n    --padding-x2: 0 var(--x2);\n}\n",
                '',
            ]);
        },
        '/h9k': function(n, o, e) {
            n.exports = e.p + 'open-sans-700.816adecd71db3dcf7b13558f87bbedb0.woff2';
        },
        0: function(n, o, e) {
            n.exports = e('12de');
        },
        '1+SF': function(n, o, e) {
            ...
            (c.insertInto = void 0),
                ...
                a.locals && (o.locals = a.locals),
                (o.use = o.ref = function() {
                    return l++ || (r = e('aET+')(a, c)), o;
                }),
                (o.unuse = o.unref = function() {
                    l > 0 && !--l && (r(), (r = null));
                });
        },
        '12de': function(n, o, e) {
            ...
            var u = ({ pages: n, selectedPage: o, setSelectedPage: e }) => {
                    const r = Object(i.a)([_.a]),
                        c = Object(a.useCallback)(n => {
                            const o = n.currentTarget.dataset.name;
                            o && e(o);
                        }, []);
                    return l()(
                        'nav',
                        { className: r.componentList },
                        void 0,
                        l()('div', { className: r.title }, void 0, p),
                        l()(
                            'ul',
                            {},
                            void 0,
                ...
                x = e('1+SF'),
                f = e.n(x),
                y = l()('h1', {}, void 0, 'Something went wrong.');
            var v = class extends c.a.Component {
                static getDerivedStateFromError(n) {
                    return console.log('getDerivedStateFromError', n), { hasError: !0 };
                }
                constructor(n) {
                    super(n), (this.state = { hasError: !1 });
                }
                componentDidCatch(n, o) {
                    console.log('componentDidCatch', n, o);
                }
                render() {
                    return this.state.hasError ? y : this.props.children;
                }
            };
            const m = l()('div', {}, void 0, 'Loading...');
            var h = l()('path', { d: 'M0 382.5h459v-51H0v51zM0 255h459v-51H0v51zM0 76.5v51h459v-51H0z' }),
                w = l()('h3', {}, void 0, 'Layout UI-Kit');
            var k = n => {
                    const o = Object(i.a)([f.a]),
                        e = Object(a.lazy)(async () => n.getPage());
                    return c.a.createElement(
                        ...
                        l()(
                            ...
                            l()(
                                'svg',
                                { className: o.menu_icon, onClick: n.menuBtnClickHandler, viewBox: '0 0 459 459' },
                                void 0,
                                h,
                            ),
                            w,
                        ...
                        l()(
                            'div',
                            { className: o['content-wrapper'] },
                            void 0,
                            l()(
                                'div',
                                { className: o.content },
                                void 0,
                                l()(v, {}, void 0, l()(a.Suspense, { fallback: m }, void 0, l()(e, {}))),
                            ),
                        ),
                    );
                },
                ...
                E = e.n(S);
            var z = {
                Button: () => Promise.all([e.e(1), e.e(0), e.e(2)]).then(e.bind(null, 'xdqe')),
                Shadows: () => Promise.all([e.e(1), e.e(0), e.e(4)]).then(e.bind(null, '5Spt')),
            };
            function C() {
                return e.e(3).then(e.bind(null, 'aApt'));
            }
            var I = () => {
                    const n = Object(i.a)([E.a]),
                        [o, e] = Object(a.useState)(!0),
                    ...
                    return l()(
                        ...
                        { className: b },
                        void 0,
                        l()('aside', {}, void 0, l()(u, { pages: t, selectedPage: r, setSelectedPage: c })),
                        l()(
                            'main',
                            { className: n.pageContent },
                            void 0,
                            l()(k, { getPage: s, menuBtnClickHandler: () => e(!o) }),
                        ),
                    );
                },
                O = e('2SVl'),
                ...
                D = e('pgDk'),
                L = e.n(D),
                P = l()(c.a.StrictMode, {}, void 0, l()(I, {}));
            var G = () => (Object(i.a)([B.a, A.a, L.a]), P);
            const N = 'root';
            var T = l()(G, {});
            function j() {
                const n = document.querySelector('body');
                n && n.classList.add('interactive');
            }
            function F() {
                let n = document.getElementById(N);
                return (
                    n || ((n = document.body.appendChild(document.createElement('main'))).id = N),
                    s.a.render(T, n, j),
                    !0
                );
            }
        ...
        '7lTm': function(n, o, e) {
            (o = n.exports = e('I1BE')(!1)).push([
                n.i,
                '.index-container_8dc0997 {\n    display: grid;\n    margin-left: 0px;\n    height: 100%;\n    grid-template-columns: 240px 1fr;\n    grid-template-rows: 100%;\n    overflow: hidden;\n    transition: all 200ms ease-out;\n}\n.index-container_8dc0997.index-no_margin_left_03cbd5e {\n    margin-left: -240px;\n}\naside {\n    width: 100%;\n    background: rgb(244, 245, 247);\n    color: #333;\n    grid-column: 1 / 2;\n    grid-row: 1 / 2;\n    transition: all 300ms ease-out;\n}\n.index-page_content_a6d795c {\n    height: 100%;\n    background: #fff;\n    color: #000;\n    grid-column: 2 / 3;\n    grid-row: 1 / 2;\n    overflow-y: hidden;\n}\n',
                '',
            ]),
                (o.locals = {
        ...
        '96yn': function(n, o, e) {
            ...
            o.a = n => {
                ...
                return Object(r.useLayoutEffect)(() => (n.forEach(l), o), []), n.reduce(c, {});
            };
        },
        E7Ks: function(n, o, e) {
            var r = e('sEG9');
            (o = n.exports = e('I1BE')(!1)).push([
                n.i,
                "html,\nbody {\n    height: 100%;\n    line-height: 1.5;\n}\n*,\n::before,\n::after {\n    line-height: 1.5;\n}\n@font-face {\n    font-family: 'open_sans';\n    src: local('open_sans'), url(" +
                    r(e('P9pF')) +
                    ") format('woff2');\n    font-style: normal;\n    font-weight: 400;\n    font-display: swap;\n}\n\n@font-face {\n    font-family: 'open_sans';\n    src: local('open_sans'), url(" +
                    r(e('/h9k')) +
                    ") format('woff2');\n    font-style: normal;\n    font-weight: 700;\n    font-display: swap;\n}\n\nsvg {\n    position: relative;\n    display: inline-block;\n    fill: 'currentcolor';\n    max-width: 100%;\n    width: 100%;\n    height: 1.25em;\n    user-select: none;\n    vertical-align: text-bottom;\n}\n\n/* SIZES CLASS */\n.styles-x1_80425f3 {\n    --x: var(--x1);\n}\n.styles-x2_bc7f879 {\n    --x: var(--x2);\n}\n.styles-x3_0b6a08c {\n    --x: var(--x3);\n}\n.styles-x4_266f2be {\n    --x: var(--x4);\n}\n.styles-x5_79cb716 {\n    --x: var(--x5);\n}\n.styles-x6_13f6974 {\n    --x: var(--x6);\n}\n.styles-x7_7c71d87 {\n    --x: var(--x7);\n}\n.styles-x8_0644ad0 {\n    --x: var(--x8);\n}\n.styles-x9_dd12004 {\n    --x: var(--x9);\n}\n.styles-x10_0a5498c {\n    --x: var(--x10);\n}\n.styles-x11_55a9e58 {\n    --x: var(--x11);\n}\n.styles-x12_f5d3d86 {\n    --x: var(--x12);\n}\n.styles-x13_3c83897 {\n    --x: var(--x13);\n}\n.styles-x14_70fb27b {\n    --x: var(--x14);\n}\n.styles-x15_c10b20a {\n    --x: var(--x15);\n}\n.styles-x16_5d0e93a {\n    --x: var(--x16);\n}\n.styles-x17_d2fad66 {\n    --x: var(--x17);\n}\n.styles-x18_e1ba3f7 {\n    --x: var(--x18);\n}\n\n/* COLOR CLASS */\n.styles-color-orange_305d5b1 {\n    --color: var(--color_orange);\n}\n.styles-bg-color-orange_fcff687 {\n    --bg-color: var(--color_orange);\n}\n\n.styles-color-orange-75_3a6efd4 {\n    --color: var(--color_orange_75);\n}\n.styles-bg-color-orange-75_b3a7744 {\n    --bg-color: var(--color_orange_75);\n}\n\n.styles-color-white_ee2b4cf {\n    --color: var(--color_white);\n}\n.styles-bg-color-white_266a2d8 {\n    --bg-color: var(--color_white);\n}\n\n.styles-color-white-25_ad246ef {\n    --color: var(--color_white_25);\n}\n.styles-bg-color-white-25_8d268a9 {\n    --bg-color: var(--color_white_25);\n}\n\n.styles-color-white-50_418d5bb {\n    --color: var(--color_white_50);\n}\n.styles-bg-color-white-50_cac67f1 {\n    --bg-color: var(--color_white_50);\n}\n\n.styles-color-purple_7751541 {\n    --color: var(--color_purple);\n}\n.styles-bg-color-purple_3155902 {\n    --bg-color: var(--color_purple);\n}\n\n.styles-color-purple-25_4203025 {\n    --color: var(--color_purple_25);\n}\n.styles-bg-color-purple-25_7f12c15 {\n    --bg-color: var(--color_purple_25);\n}\n\n.styles-color-purple-50_1b45414 {\n    --color: var(--color_purple_50);\n}\n.styles-bg-color-purple-50_7d7f4b0 {\n    --bg-color: var(--color_purple_50);\n}\n\n.styles-color-purple-75_ea07d43 {\n    --color: var(--color_purple_75);\n}\n.styles-bg-color-purple-75_e54fb9d {\n    --bg-color: var(--color_purple_75);\n}\n\n.styles-color-green_c35bbed {\n    --color: var(--color_green);\n}\n.styles-bg-color-green_1763ce4 {\n    --bg-color: var(--color_green);\n}\n\n.styles-color-green-75_f7b03bd {\n    --color: var(--color_green_75);\n}\n.styles-bg-color-green-75_544d98a {\n    --bg-color: var(--color_green_75);\n}\n\n.styles-color-black_685f3f1 {\n    --color: var(--color_black);\n}\n.styles-bg-color-black_a9f6b99 {\n    --bg-color: var(--color_black);\n}\n\n.styles-color-black-50_abae999 {\n    --color: var(--color_black_50);\n}\n.styles-bg-color-black-50_73bddd6 {\n    --bg-color: var(--color_black_50);\n}\n\n.styles-color-gray_690c469 {\n    --color: var(--color_gray);\n}\n.styles-bg-color-gray_33c7f95 {\n    --bg-color: var(--color_gray);\n}\n\n.styles-color-gray-75_514f9d3 {\n    --color: var(--color_gray_75);\n}\n.styles-bg-color-gray-75_647ef0c {\n    --bg-color: var(--color_gray_75);\n}\n\n.styles-color-gray-50_40864f3 {\n    --color: var(--color_gray_50);\n}\n.styles-bg-color-gray-50_7a70574 {\n    --bg-color: var(--color_gray_50);\n}\n\n.styles-color-gray-25_56ba8ed {\n    --color: var(--color_gray_25);\n}\n.styles-bg-color-gray-25_1108585 {\n    --bg-color: var(--color_gray_25);\n}\n\n/* RADIUS CLASS */\n.styles-border-radius-x1_9bdaf87 {\n    --radius: var(--border-radius-x1);\n}\n.styles-border-radius-50_78fd29f {\n    --radius: var(--border-radius-50);\n}\n\n/* scrollbar styles */\n::-webkit-scrollbar {\n    width: 4px;\n    height: 3px;\n}\n::-webkit-scrollbar-button {\n    display: none;\n    background-color: #666;\n}\n::-webkit-scrollbar-track {\n    background-color: #999;\n}\n::-webkit-scrollbar-track-piece {\n    background-color: var(--color_gray_50);\n}\n::-webkit-scrollbar-thumb {\n    border-radius: 3px;\n    background-color: var(--color_gray);\n}\n::-webkit-scrollbar-corner {\n    background-color: #999;\n}\n::-webkit-resizer {\n    background-color: #666;\n}\n",
                '',
            ]),
                (o.locals = {
        ...
        P9pF: function(n, o, e) {
            n.exports = e.p + 'open-sans-400.8a445b21d76f362afebf945d89501b0e.woff2';
        },
        cDcd: function(n, o) {
            n.exports = React;
        },
        ...
        qOaT: function(n, o, e) {
            (o = n.exports = e('I1BE')(!1)).push([
                n.i,
                "html,\n*,\n:before,\n:after {\n    box-sizing: content-box;\n}\n\nhtml {\n    min-width: 0;\n    overflow: hidden;\n    color: rgb(66, 82, 110);\n    font-family: 'open_sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Fira Sans',\n        'Droid Sans', 'Helvetica Neue', sans-serif;\n    font-size: var(--x4);\n}\nhtml,\nbody,\nmain {\n    height: 100%;\n}\n\np {\n    margin: 0 0 var(--x4) 0;\n}\nul {\n    margin-left: var(--x4);\n}\nsection {\n    padding-top: 32px;\n}\n\nhtml,\n.app-root_2baa8ea {\n    font-size: 16px;\n    line-height: 24px;\n}\nbody,\n.article {\n    margin: auto;\n    font-size: 1rem;\n    line-height: 1.5rem;\n}\nh1,\n.h1 {\n    margin-top: 1.5rem;\n    margin-bottom: 3rem;\n    font-size: 2.375rem;\n    line-height: 3rem;\n}\nh2,\n.h2 {\n    margin-top: 1.5rem;\n    margin-bottom: 1.5rem;\n    font-size: 1.75rem;\n    line-height: 3rem;\n}\nh3,\n.h3 {\n    margin-top: 1.5rem;\n    margin-bottom: 0rem;\n    font-size: 1.3125rem;\n    line-height: 1.5rem;\n}\nh4,\n.h4 {\n    margin-top: 1.5rem;\n    margin-bottom: 0rem;\n    font-size: 1rem;\n    line-height: 1.5rem;\n}\nh5,\n.h5 {\n    margin-top: 1.5rem;\n    margin-bottom: 0rem;\n    font-size: 1rem;\n    line-height: 1.5rem;\n}\np,\nul,\nol,\npre,\ntable,\nblockquote {\n    margin-top: 0rem;\n}\nul ul,\nol ol,\nul ol,\nol ul {\n    margin-top: 0rem;\n}\n\n/* Let's make sure all's aligned */\nhr,\n.hr {\n    margin: -1px 0;\n    border: 1px solid;\n}\na,\nb,\ni,\nstrong,\nem,\nsmall,\ncode {\n    line-height: 0;\n}\nsub,\nsup {\n    position: relative;\n    line-height: 0;\n    vertical-align: baseline;\n}\nsup {\n    top: -0.5em;\n}\nsub {\n    bottom: -0.25em;\n}\n",
                '',
            ]),
                (o.locals = { root: 'app-root_2baa8ea' });
        },
        s5nN: function(n, o, e) {
            (o = n.exports = e('I1BE')(!1)).push([
                n.i,
